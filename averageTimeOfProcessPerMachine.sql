...
# use the condition "b.activity_type = 'end' AND a.activity_type = 'start'" in the WHERE clause to ensure that you are only considering pairs where the 'start' activity comes before the 'end' activity for each (machine_id, process_id) pair.
