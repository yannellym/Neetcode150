...
class RandomizedSet:
    ...
    def __init__(self):
        self.mydict = {}
        self.myset = set() # stores val
        

    def insert(self, val: int) -> bool:
        # if the value is not in the dictionary
        if val not in self.mydict:
            # add it to the dictionary and set its value to true
    ...
    def remove(self, val: int) -> bool:
        # if the val is in the dictionary
        if val in self.mydict:
            ...
            return True
        # if it wasnt removed, return false
        return False
        

    def getRandom(self) -> int:
        # https://www.geeksforgeeks.org/python-random-sample-function/# 
        # get a list of random samples of length 1 from myset, and return the first val
